            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 mb-5 mb-lg-0 mb-xl-0" style="margin-top: 10%;">
                    <div class="title_sections ">
                        ...
                        <div class="before_title " style="margin-left: 1.5rem;">Stay up-to-date with our
                            latest
                            insights</div>
                    </div>
                </div>
                <div class="col-xl-8 col-lg-8 mb-5 mb-lg-0 mb-xl-0">
                    <div class="icon_box_all style_one" style="background-color: rgba(255,255,255,.1); margin-top: 5%;">
                        <div class="icon_content icon_centers">
                            <div class="row">
                                <div class="col-lg-7">
                                    <p class="" style="font-size: 0.9rem;">Blog Type : Web Development</p>
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="row " style="margin-bottom: 1.5rem; margin-left: -1rem;">
                                        <p style="margin-top: 2%; font-size: 12px; " class="col-lg-6">23
                                            July
                                            2023</p>
                                        <p style="margin-top: 2%; font-size: 12px;" class="col-lg-6">250
                                            Views
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div class="icon_box_all style_one" style="background-color: rgba(255,255,255,.1); margin-top: 5%;">
                        <div class="icon_content icon_centers">
                            <div class="">
                                ...
                                <p class="" style="font-size: 0.9rem;">Blog Type : UI/UX Design</p>
                                ...
                                <p style="margin-top: 2%; font-size: 16px;">Lorem Ipsum is simply dummy text of the
                                    printing and....</p>
                                <div class="row " style="margin-bottom: 1.5rem; margin-left: -1rem;">
                                    <p style="margin-top: 2%; font-size: 12px; " class="col-lg-6 ">23 July
                                        2023</p>
