<!-- Header File -->
<?php $current_page_url = "https://avtarspace.com/cloud-computing";
$title = 'AST | Cloud Computing';
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-mb-6 mb-lg-5 mb-xl-0">
                    <div class="image_boxes style_three">
                        <img src="assets/images/service/cloud-img-1.svg" class="img-fluid object-fit-cover" alt="Cloud Computing" style="width: 80%;">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6 col-mc-12">
                    <div class="title_all_box style_one content_box_cn">
                        <div class="title_sections ">
                            <div class="content_box_cn style_one">
                                <div class="">
                                    <h2 class="">Cloud Computing Includes</h2>
                                </div>
                            </div>
