...
<div id="content" class="site-content">
                    ...
                    <div class="title_all_box style_two dark_color">
                        <div class="title_sections two">
                            ...
                            <div class="description_box ">
                                <p>
                                    Avtar Space Technology is a leading software development and IT consulting company. We provide quality solutions for online businesses using cutting-edge web technologies and platforms. Our services are designed to transform your investment into revenue while providing you with the best for money.
                                </p>
                                <div class="mr_bottom_10"></div>
                                <p>
                                    AST promotes digital transformation for businesses worldwide, including London, Singapore, Turkey, Philippines and ensures to support their partner's efforts to leverage and benefit from current global trends.
                                </p>
                            </div>
                        </div>
                        <!--===============spacing==============-->
                        ...
                        <div class="icon_content icon_centers">
                            <div class="txt_content">
                                ...
                                <p style="margin-top: 2%; font-size: 18px;">
                                    Avtar Space Technology provides effective solutions with the help of our highly skilled professionals, and we aim to revolutionize the technological aspect through our cutting-edge software development services. We always deliver quality, and our commitment allows us to create software that helps enterprises and individuals. We redefine possibilities and shape the future of software technology.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <!-- --------------- Industries we serve our services end ------- -->
        ...
        <div class="container">
            <div class="col-lg-12">
                <div class="title_all_box style_one text-center dark_color">
                    <div class="title_sections">
                        <h2 class=" aboutleaders-stroke">Meet the Leaders</h2>
                    </div>
                </div>
            </div>
            <!--===============spacing==============-->
