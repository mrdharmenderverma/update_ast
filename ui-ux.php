            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-mb-6 mb-lg-5 mb-xl-0">
                    <div class="image_boxes style_three">
                        <img src="assets/images/service/UIux Design.png" class="img-fluid object-fit-cover" alt="UI/UX Design">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-mb-6 mb-lg-5 mb-xl-0">
                    <div class="image_boxes style_three">
                        <img src="assets/images/service/img-2.png" class="img-fluid object-fit-cover" alt="UI/UX Designs includes">
                    </div>
                </div>
