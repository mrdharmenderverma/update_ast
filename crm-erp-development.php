<!-- Header File -->
<?php $current_page_url="https://avtarspace.com/crm-erp-development"; $title = 'AST | CRM & ERP Developement'; include_once 'header.php'; ?>
<!-- Header File -->
<!--===============PAGE CONTENT ==============-->
            ...
            <div class="row align-items-center">
                        ...
                        <div class="title_sections ">
                            <div class="content_box_cn style_one">
                                <div class="txt_content">
                                    <h2 class="">CRM & ERP  Development</h2>
                                </div>
                            </div>
                            ...
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                Lorem Ipsum has been the industry's standard dummy s,</p>
                        </div>
                    </div>
                    <!--===============spacing==============-->
                ...
                <div class="col-lg-6 col-mb-6 mb-lg-5 mb-xl-0">
                    <div class="image_boxes style_three">
                        <img src="assets/images/service/CRM-IMG-1.png" class="img-fluid object-fit-cover" alt="CRM & ERP  Development">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-mb-6 mb-lg-5 mb-xl-0">
                    <div class="image_boxes style_three">
                        <img src="assets/images/service/CRM-IMG-2.png" class="img-fluid object-fit-cover" alt="CRM & ERP Dev">
                    </div>
                </div>
                <div class="col-lg-6 col-mc-12">
                    <div class="title_all_box style_one content_box_cn">
                        <div class="title_sections ">
                            <div class="content_box_cn style_one">
                                <div class="txt_content">
                                    <h2 class="">CRM & ERP Dev <br> Includes</h2>
                                </div>
                            </div>
